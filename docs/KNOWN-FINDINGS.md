...
| MOR variable not found | Die TCG-MOR-Control-Variable muss von der Firmware bereitgestellt werden. Fehlt sie, bleibt der Lynis-Hinweis sichtbar; das Tool erzeugt oder überschreibt keine EFI-Variable über efivarfs. | Firmware-/Plattformdokumentation prüfen und nur eine vom Hersteller unterstützte MOR-Konfiguration verwenden. |
